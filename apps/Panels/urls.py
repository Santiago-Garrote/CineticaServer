...
urlpatterns = [
    ...
    path('SectionalPanels/<int:pk>', UpdateSectionalPanelView.as_view(), name='updateSectionalPanel'),
    ...
    path('PrincipalPanels/<int:pk>', UpdatePrincipalPanelView.as_view(), name='updatePrincipalPanel'),
]